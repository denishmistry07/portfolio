window.addEventListener("load", function () {
  ...
  function Imageslider(selcetor) {
    ...
    gsap.utils.toArray(selcetor).forEach((element, index, array) => {
      // const rotationXValue = -20 + (index + 1) * (-20 / array.length); // Adjust the values based on your requirements
      const zValue = -500 - (index + 1) * (-500 / array.length); // Adjust the values based on your requirements
      console.log(zValue)
      gsap.set(element, {
        x: 0,
        y: 0,
  ...
  Imageslider(".project-wrapper a>div");
  // console.log(mobile)
  // ===================================
  ...
  document.querySelectorAll('.project-main').forEach((event) => {

    event.querySelector('.project-list').addEventListener("click", (e) => {

      document.body.style.position = "fixed";
      event.querySelector(".project-detail").classList.add("active");

    });
    event.querySelector('.close-project-detail').addEventListener("click", (e) => {
     event.querySelector(".project-detail").classList.remove("active");
...
function initModalScroll() {
  var modalContent = document.querySelectorAll('.project-detail');
  modalContent.forEach(function(element){
    SmoothScroll(element, 120, 12);
  })
